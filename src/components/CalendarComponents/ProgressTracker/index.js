  ...
  return (
    <>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <Animated.View entering={FadeInUp.duration(500).delay(100)} style={styles.progressHeader}>
        ...
        <Animated.View entering={FadeInUp.duration(500).delay(200)} style={styles.comparisonContainer}>
                ...
                <>
                  <View style={styles.imageContainer}>
                    ...
                    <View style={styles.dateBadge}>
                      <Text style={styles.dateBadgeText}>{moment(uploadDate1).format('MMM D')}</Text>
                    </View>
                  </View>
                </>
              ) : (
              ...
              {image2 ? (
                <>
                  <View style={styles.imageContainer}>
                    ...
                    <View style={styles.dateBadge}>
                      <Text style={styles.dateBadgeText}>{moment(uploadDate2).format('MMM D')}</Text>
                    </View>
                  </View>
                </>
              ) : (
        ...
        <Animated.View entering={FadeInUp.duration(500).delay(300)} style={styles.analyzeButtonContainer}>
          <TouchableOpacity
        ...
        {analysisResult && !modalVisible && (
          <Animated.View entering={FadeInDown.duration(700)} style={styles.analysisResultContainer}>
            <LinearGradient colors={['#ffffff', '#f8f5ff']} style={styles.analysisCard}>
